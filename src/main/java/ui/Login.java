...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bg.add(citybg, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 0, 370, 520));
        ...
        exitTxt.setBackground(new java.awt.Color(150, 150, 150));
        ...
        favicon.setText("SwiftFold");
        bg.add(favicon, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 70, 250, 50));

        title.setFont(new java.awt.Font("Roboto Black", 1, 24)); // NOI18N
        title.setText("INICIAR SESIÓN");
        bg.add(title, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 200, -1, -1));
        ...
        bg.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 310, 410, 20));
        ...
        bg.add(passTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 360, 410, 30));

        jSeparator2.setForeground(new java.awt.Color(0, 0, 0));
        bg.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 390, 410, 20));

        loginBtn.setBackground(new java.awt.Color(51, 153, 0));

        loginBtnTxt.setBackground(new java.awt.Color(0, 153, 0));
        ...
        bg.add(Logo, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 60, 100, 70));

        jLabel1.setFont(new java.awt.Font("Roboto Condensed", 0, 18)); // NOI18N
        jLabel1.setText("Organizador de documentos de las alcaldías de Colombia");
        bg.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 150, -1, -1));
